...
Open the Bot page and create a bot user.

Under Privileged Gateway Intents, enable Message Content Intent.

Copy the bot token for the environment configuration below.

In OAuth2 > URL Generator, select the bot scope and grant these bot
permissions:
...
Discord bot token used to sign in

icon

No

Image URL shown beside the author in the help embed

ig

No

Link used by the author name in the help embed
...
Search for and immediately play a track. If a track is already playing, it is replaced.

!play Blinding Lights

!next <song>

Add a track to the server's queue. If nothing is playing, start it immediately.
...
Skip the current track and play the next queued track, if available.
...
Disconnect the bot from the voice channel and clear the server queue.

!stop

!help

Display the command list in Discord.
